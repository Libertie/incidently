...
<div class="form-row">
    <div class="form-group col-md-6">
        {{ Form::label('date') }}
        {{ Form::date('date', ($incident->occurred_at ?? now()), [
            'class' => 'form-control'
        ]) }}
        @error('occurred_at')
    ...
    <div class="form-group col-md-6">
        {{ Form::label('time') }}
        {{ Form::time('time', ($incident->occurred_at ?? now()), [
            'class' => 'form-control'
        ]) }}
    </div>
</div>
...
<div class="form-group">
    ...
    <p class="form-text text-muted">Please select all that apply.</p>
    @error('types')
    <p class="form-text text-danger">{{ $message }}</p>
    @enderror
</div>
...
<div class="form-group">
    ...
    <p class="form-text text-muted">
        Was anyone else present? Please include contact information, where available.
    </p>
</div>
